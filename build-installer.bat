@echo off
title Lovecord Installer - Build
cd /d "%~dp0"

echo.
echo  ================================
echo   Lovecord Installer - Build
echo  ================================
echo.
...
:: Build electron-builder -> Lovecord-Installer.exe dans ../release/installer/
echo.
...
:: Verification
if not exist "release\installer\Lovecord-Installer.exe" (
    echo.
    echo  [ERREUR] Lovecord-Installer.exe introuvable apres build.
    pause
    exit /b 1
)

for %%F in ("release\installer\Lovecord-Installer.exe") do (
    echo.
    echo  [OK] Build reussi ^!
    echo  Fichier : release\installer\Lovecord-Installer.exe  (%%~zF octets^)
    echo.
)
