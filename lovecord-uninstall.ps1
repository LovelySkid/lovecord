# ==============================================================================
#  Lovecord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Lovecord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Lovecord-Client"
...
Write-Host "  ║      LOVECORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Lovecord désinstallé avec succès !                 │" -ForegroundColor Green
