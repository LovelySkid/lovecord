...
[[ -z "$NOTES" ]] && NOTES="Lovecord $VERSION"

# ── Config Gitea ──────────────────────────────────────────────────────────────
GITEA_URL="https://source.lovecord.gg"
GITEA_REPO="lovecord/lovecord"
...
DIST_ZIP="$OUT_DIR/lovecord-dist.zip"
INSTALLER_EXE="$OUT_DIR/Lovecord-Installer.exe"
...
# ── 5. Compiler Lovecord-Installer.exe ──────────────────────────────────────
echo ""
...
echo " [5/8] Lovecord-Installer.exe cree ($INSTALLER_SIZE octets)"

# ── 6. Créer lovecord-dist.zip ──────────────────────────────────────────────
echo ""
...
echo " [6/8] lovecord-dist.zip cree ($DIST_ZIP_SIZE octets)"
...
cat > "$VERSION_JSON" <<EOF
{
  ...
  "installerUrl": "$GITEA_URL/$GITEA_REPO/releases/download/v$VERSION/Lovecord-Installer.exe",
  "distUrl": "$GITEA_URL/$GITEA_REPO/releases/download/v$VERSION/lovecord-dist.zip",
...
upload_asset "$INSTALLER_EXE" "Lovecord-Installer.exe" "application/octet-stream"
upload_asset "$DIST_ZIP"      "lovecord-dist.zip"      "application/zip"
