...
import { ContributeModal } from "../../../../lovecord/renderer/components/ContributeModal";
        ...
        <>
            <QuickActionCard>
                <QuickAction
                    Icon={GithubIcon}
                    text="Source Code"
                    action={() => VencordNative.native.openExternal("https://source.lovecord.gg/lovecord/lovecord")}
                />
                <QuickAction
                    Icon={PaintbrushIcon}
                    text="Edit QuickCSS"
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="Lovecord Channel"
                    action={() => VencordNative.native.openExternal("https://t.me/lovecordoff")}
                />
            </QuickActionCard>
...
function useCompactActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("lovecord-compact-change", handler);
        return () => window.removeEventListener("lovecord-compact-change", handler);
    }, []);
    return active;
}
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("lovecord-stealth-change", handler);
        return () => window.removeEventListener("lovecord-stealth-change", handler);
    }, []);
    return active;
}
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {enabled
                    ? "Stealth mode is enabled â€” all Lovecord visual elements are hidden. Shortcut: Ctrl+Shift+H"
                    : t("Hides all Lovecord visual elements without disabling plugins. Shortcut: Ctrl+Shift+H")}
            </Paragraph>
            <Button
...
function MellowtelSupportSwitch() {
    ...
    return (
        <FormSwitch
            ...
            title={t("Share bandwidth to support Lovecord (Mellowtel)")}
            description={
                consent
                    ? undefined
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    {t("Configure how Lovecord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.")}
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    {t("Configure how Lovecord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.")}
                </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Replaces all Lovecord buttons with a single compact toggle icon. Click the icon in the header bar, channel toolbar, or chat bar to restore all buttons.")}
            </Paragraph>
            <Button
...
export default wrapTab(EquicordSettings, "Lovecord Settings");
