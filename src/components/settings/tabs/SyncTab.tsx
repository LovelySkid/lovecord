...
function lovecordIcon() {
    return <img src={lovecord_ICON_DATA_URI} alt="lovecord" style={ICON_STYLE} />;
}
...
const cloudBackendOptions = [
    { label: "Lovecord Cloud", value: "https://api.lovecord.gg/" },
...
const BADGE_OPTIONS: Array<{ label: string; value: BadgeSource }> = [
    { label: "Lovecord Badges", value: "lovecord" },
...
function renderPrefix(option: { value: BadgeSource }) {
    switch (option.value) {
        case "lovecord": return <LovecordIcon />;
    ...
    return (
        <div style={{ marginBottom: 16 }}>
            <FormSwitch
                ...
                title={t("Lovecord Sync")}
                description={isEnabled
                    ? t("Your custom profile is synced. Other Lovecord users can see your profile, and you can see theirs.")
                    : t("Enable to share your custom profile with other Lovecord users and see their profiles.")}
                disabled={busy}
            />
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Lovecord's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.")}
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                {t("We use our own Lovecord Cloud backend with enhanced features.")}
                {" "}
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    renderOptionPrefix={o => {
                        if (o?.value?.includes("lovecord")) return <LovecordIcon />;
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Synchronize your Lovecord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.")}
            </Paragraph>
