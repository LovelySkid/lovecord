 ...
 * video in https://source.lovecord.gg/lovecord/lovecord-tutorials/src/branch/main/videos
 *
...
/**
 * Set of plugin names that have a tutorial video available in lovecord-tutorials.
