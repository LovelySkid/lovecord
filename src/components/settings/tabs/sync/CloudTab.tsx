        ...
        <SettingsTab>
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    closeOnSelect={true}
                    renderOptionPrefix={o => o?.value?.includes("lovecord") ? <LovecordIcon /> : o?.value?.includes("equicord") ? <EquicordIcon /> : <VencordIcon />}
                />
            </div>
