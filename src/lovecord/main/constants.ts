...
const LovecordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(LovecordDir, "Uninstall Lovecord.exe"));

export const DATA_DIR =
    process.env.Lovecord_USER_DATA_DIR || (PORTABLE ? join(LovecordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Lovecord/${app.getVersion()} (https://git.${domain}/lovecord/lovecord)`;
