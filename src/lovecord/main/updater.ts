...
// Lovecord native defaults — no external prefs file, always on
const LOVECORD_PREFS = { defaultPlugins: true, autoUpdate: true } as const;

export const installerPrefs = LOVECORD_PREFS;

handle(IpcEvents.GET_INSTALLER_PREFS, () => LOVECORD_PREFS);
