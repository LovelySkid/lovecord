...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Lovecord/types/components";
import { FluxDispatcher, InviteActions } from "@Lovecord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Lovecord and Lovecord are fully up to date. You can get help in our{" "}
