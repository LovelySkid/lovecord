...
import {
    ...
    RestartIcon,
    Span
} from "@Lovecord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { onceReady } from "@Lovecord/types/webpack";
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Lovecord/types/webpack/common";
...
const logger = new Logger("LovecordScreenShare");
