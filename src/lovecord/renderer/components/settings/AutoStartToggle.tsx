...
import { useState } from "@Lovecord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Lovecord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Lovecord minimized when starting with system"}
