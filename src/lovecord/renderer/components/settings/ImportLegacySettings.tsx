...
import { BaseText } from "@Lovecord/types/components";
import { React, useRef,useState } from "react";

import { cl } from "./Settings";

function detectSource(json: any): "equicord" | "vencord" | "lovecord" | "unknown" {
    ...
    // Plugins spécifiques à Lovecord
    if (pluginNames.some(p => ["LovecordHelper", "equicordHelper"].includes(p))) return "lovecord";
...
function cleanForLovecord(json: any): any {
    ...
    // Supprimer les plugins propres à Equicord/Vencord qui n'existent pas dans Lovecord
    ...
    async function processFile(file: File) {
        ...
        try {
            ...
            const sourceLabel =
                ...
                source === "lovecord" ? "Lovecord" : "inconnu";

            const cleaned = cleanForLovecord(json);
            ...
            setStatus("success");
            setMessage(`✅ Settings ${sourceLabel} importés avec succès ! Redémarre Lovecord pour appliquer.`);
        } catch (err: any) {
            setStatus("error");
    ...
    return (
        <div className={cl("category")}>
            ...
            <BaseText size="sm" style={{ marginBottom: "12px", opacity: 0.7 }}>
                Drag & drop your Equicord or Vencord backup JSON file here to import your settings into Lovecord.
                Plugin-specific settings that don't exist in Lovecord will be automatically removed.
            </BaseText>
