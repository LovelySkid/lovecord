...
import { BaseText, Button, FormSwitch } from "@Lovecord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Lovecord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`lovecord://assets/${asset}?v=${version}`}
                    alt=""
