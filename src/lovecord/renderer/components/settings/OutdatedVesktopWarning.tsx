...
import { Button, Card, HeadingTertiary, Paragraph } from "@Lovecord/types/components";
import { useAwaiter } from "@Lovecord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Lovecord is outdated!</HeadingTertiary>
