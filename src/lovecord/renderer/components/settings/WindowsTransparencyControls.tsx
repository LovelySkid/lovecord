...
import { Heading, Paragraph } from "@Lovecord/types/components";
import { Margins } from "@Lovecord/types/utils";
import { Select } from "@Lovecord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Lovecord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
