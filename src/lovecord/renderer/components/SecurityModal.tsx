...
import { Button, Flex, Heading, Paragraph } from "@Lovecord/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot } from "@Lovecord/types/utils";
import { React } from "@Lovecord/types/webpack/common";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        LovecordFr is a 100% Free product.
                    </Paragraph>
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        ...
                        <li style={{ color: "var(--text-normal)" }}>
                            ...
                            <span
                                ...
                                onClick={() => VencordNative.native.openExternal("https://discord.gg/lovecord")}
                            >
                                discord.gg/lovecord
                            </span>
                        </li>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download LovecordFr via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
