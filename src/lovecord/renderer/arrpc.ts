...
import { Logger } from "@Lovecord/types/utils";
import { findLazy, onceReady } from "@Lovecord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Lovecord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("LovecordRPC", "#5865f2");
