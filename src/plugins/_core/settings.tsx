...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Lovecord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const fullEntries: SettingsLayoutNode[] = [
            ...
            buildEntry({
                ...
                panelTitle: "Lovecord Sync",
                Component: SyncTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "lovecord_language",
                title: "Language",
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("Lovecord_stealthMode") === "1") return ""; } catch { }
                return t("Lovecord Settings");
            },
            buildLayout: () => {
                try { if (localStorage.getItem("Lovecord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`Lovecord ${gitHashShort}${getVersionInfo()}`];
