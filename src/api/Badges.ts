...
export function _getBadges(args: BadgeUserArgs) {
    ...
    const lovecordBadges = (BadgeAPIPlugin as any).getLovecordBadges?.(args.userId);
    const lovecordBadges = (BadgeAPIPlugin as any).getlovecordBadges?.(args.userId);
    ...
    if (lovecordBadges && !isHidden("lovecord")) {
        badges.unshift(...lovecordBadges.map(shieldBadge));
    }
