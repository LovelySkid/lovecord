...
// through the cracks: window.__lovecordPCLReset()
...
export default definePlugin({
    ...
    authors: [{ name: "arg0NNY (ported by Lovecord)", id: 0n }],
    settings,
    ...
    async start() {
        ...
        (window as any).__lovecordPCLReset = () => forceReset("manually triggered via window.__lovecordPCLReset()");
    ...
    stop() {
        ...
        clearTimeout(autolockTimeout);
        clearTimeout(watchdogTimeout);
        delete (window as any).__lovecordPCLReset;
