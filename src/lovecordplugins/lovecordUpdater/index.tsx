...
// Config
const REMOTE_VERSION_URL = `https://source.${domain}/api/v1/repos/lovecord/lovecord/releases/latest`;
...
async function checkForUpdates() {
    try {
        ...
        console.error("[LovecordUpdater] Error:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.lovecord?.relaunch?.();
                } catch {
            ...
            console.error("[LovecordUpdater] Update error:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `Lovecord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("lovecord-updater-root")) return;

    waitFor(["createRoot", "render"], (ReactDOM: any) => {
        if (bannerContainer || document.getElementById("lovecord-updater-root")) return;
        bannerContainer = document.createElement("div");
        bannerContainer.id = "lovecord-updater-root";
        ...
        try {
            ...
            console.error("[LovecordUpdater] Error mounting banner:", e);
...
export default definePlugin({
    name: "LovecordUpdater",
    enabledByDefault: true,
    description: "Shows a banner when a new Lovecord version is available. Click Update to install.",
