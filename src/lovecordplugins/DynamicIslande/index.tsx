...
import { settings as musicControlsSettings } from "@lovecordplugins/musicControls/settings";
import { SpotifyStore } from "@lovecordplugins/musicControls/spotify/SpotifyStore";
...
const cl = classNameFactory("vc-lovecord-dynamic-island-");
const NOTIFICATION_DURATION = 5000;
const RUNTIME_KEY = Symbol.for("lovecordDynamicIsland.runtime");
            ...
            {showVolume && (
                <div style={{ padding: "0 4px" }}>
                    <input 
                        ...
                        max={100} 
                        value={sc.volume} 
                        className="vc-lovecord-dynamic-island-volume-slider"
...
function ParticipantRow({ p, channel, currentUser }: { p: { user: any; member: any }; channel: any; currentUser: any; }) {
    ...
    return (
        <div 
            className="vc-lovecord-dynamic-island-participant-row"
            onContextMenu={(e) => {
                e.preventDefault();
    ...
    return (
        ...
        >
            ...
            {showCallParticipants && expanded && participants.length > 0 && (
                <div 
                    className="vc-lovecord-dynamic-island-voice-participants-list"
                    style={{ 
                        display: "flex", 
                        flexDirection: "column", 
                        gap: "6px", 
