...
import { providers } from "@lovecordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@lovecordplugins/musicControls/spotify/lyrics/providers/store";
