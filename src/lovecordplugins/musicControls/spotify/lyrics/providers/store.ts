...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@lovecordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@lovecordplugins/musicControls/spotify/SpotifyStore";
