...
import { SafeDynamicIsland } from "@lovecordplugins/DynamicIslande";
    ...
    try {
        ...
        FluxDispatcher.dispatch({
            ...
            activity: {
                ...
                metadata: {
                    button_urls: [`https://lovecord.gg/listen?sc_id=${p.playing.id}&start=${start}&userId=${myUserId}`, "https://lovecord.gg"],
                },
                flags: 1,
            }
        });
...
export default definePlugin({
    ...
    start() {
        ...
        documentClickHandler = (e: MouseEvent) => {
            ...
            if (href.startsWith("https://lovecord.gg/listen?") || href.startsWith("http://lovecord.gg/listen?")) {
                e.preventDefault();
                e.stopPropagation();
                try {
