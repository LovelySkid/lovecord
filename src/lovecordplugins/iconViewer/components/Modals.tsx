...
function OtherContextMenu({ iconName, Icon, color }: { iconName: string; Icon: any; color: number; }) {
...
function IconModal({ iconName, Icon, onClose, transitionState }: { iconName: string; Icon: any; } & ModalProps) {
...
export function openIconModal(iconName: string, Icon: any) {
