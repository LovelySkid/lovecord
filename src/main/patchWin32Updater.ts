...
// Lovecord was installed (dev-inject asar, the PS1/Inno installer, or
...
function patchLatest() {
    try {
        ...
        console.info("[Lovecord] Detected Host Update. Repatching...");
        ...
        const indexJs = [
            ...
            "} catch (e) {",
            "    console.error(\"[Lovecord] Repatch injection failed, falling back to vanilla Discord:\", e);",
        ...
        console.error("[Lovecord] Failed to repatch latest host update", err);
    }
}
