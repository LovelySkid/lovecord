# ==============================================================================
#  Lovecord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Lovecord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Lovecord
$LovecordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$LovecordPatcher = $LovecordPatcher.Replace("\", "\\")
...
// Injection Lovecord
try {
    require(\"$LovecordPatcher\");
} catch (e) {
    console.error(\"Lovecord injection failed:\", e);
